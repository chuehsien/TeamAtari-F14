...
task getControlsNorm;
	...
	begin
		...
		`ADC_izx: ADC_izx(currT,phi1,phi2,carry,decMode,dummy_control,dummy_T);
		`ADC_zp : ADC_zp (currT,phi1,phi2,carry,decMode,dummy_control,dummy_T);
		`ROR_zp : ROR_zp (currT,phi1,phi2,carry,dummy_control,dummy_T);
		`PLA    : PLA    (currT,phi1,phi2,dummy_control,dummy_T);
		`ADC_imm: ADC_imm(currT,phi1,phi2,carry,decMode,dummy_control,dummy_T);
		`ROR    : ROR    (currT,phi1,phi2,carry,dummy_control,dummy_T);
		`JMP_zp : JMP_zp(currT,phi1,phi2,dummy_control,dummy_T);
		`ADC_abs: ADC_abs(currT,phi1,phi2,carry,decMode,dummy_control,dummy_T);
		`ROR_abs: ROR_abs(currT,phi1,phi2,carry,dummy_control,dummy_T);
		`ADC_zpx: ADC_zpx(currT,phi1,phi2,carry,decMode,dummy_control,dummy_T);
		`ROR_zpx: ROR_zpx(currT,phi1,phi2,carry,dummy_control,dummy_T);
		`SEI    : SEI    (currT,phi1,phi2,dummy_control,dummy_T);
		`ROR_abx: ROR_abx(currT,phi1,phi2,carry,dummy_control,dummy_T);
		...
		`SBC_izx: SBC_izx(currT,phi1,phi2,carry,decMode,dummy_control,dummy_T);
		`CPX_zp : CPX_zp (currT,phi1,phi2,dummy_control,dummy_T);
		`SBC_zp : SBC_zp (currT,phi1,phi2,carry,decMode,dummy_control,dummy_T);
		`INC_zp : INC_zp (currT,phi1,phi2,dummy_control,dummy_T);
		`INX    : INX    (currT,phi1,phi2,dummy_control,dummy_T);
		`SBC_imm: SBC_imm(currT,phi1,phi2,carry,decMode,dummy_control,dummy_T);
		`NOP    : NOP    (currT,phi1,phi2,dummy_control,dummy_T);
		`CPX_abs: CPX_abs(currT,phi1,phi2,dummy_control,dummy_T);
		`SBC_abs: SBC_abs(currT,phi1,phi2,carry,decMode,dummy_control,dummy_T);
		`INC_abs: INC_abs(currT,phi1,phi2,dummy_control,dummy_T);
		`SBC_zpx: SBC_zpx(currT,phi1,phi2,carry,decMode,dummy_control,dummy_T);
