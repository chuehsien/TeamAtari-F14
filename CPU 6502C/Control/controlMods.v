...
task getControlsNorm;
	...
	begin
		...
		`ADC_izx: ADC_izx(currT,phi1,phi2,carry,statusC,decMode,dummy_control,dummy_T);
		...
		`ADC_zpx: ADC_zpx(currT,phi1,phi2,carry,statusC,decMode,dummy_control,dummy_T);
		`ROR_zpx: ROR_zpx(currT,phi1,phi2,carry,statusC,dummy_control,dummy_T);
...
task getControlsRMW;
	...
	begin
		...
		`ADC_abx: ADC_abx(currT,phi1,phi2,decMode,carry,dummy_control,dummy_T);
